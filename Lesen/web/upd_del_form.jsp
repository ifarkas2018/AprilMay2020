                                    ...
                                    <div class="form-group">
                                        ...
                                        %>
                                            ...
                                            <% if (!input5.equalsIgnoreCase("")) { %>
                                                ...
                                                <input type="text" class="form-control form-control-sm" maxlength="13" name="isbn" id="isbn" onchange="setCookie()" onfocusout='isNumber("upd_del_book", "isbn", "is_isbn", "isbn_message", false, false)' value="<%= input5 %>"> 
                                            <!-- otherwise read the record from the DB and show it -->
                                            <% } else { %>
                                                <input type="text" class="form-control form-control-sm" maxlength="13" name="isbn" id="isbn" onchange="setCookie()" onfocusout='isNumber("upd_del_book", "isbn", "is_isbn", "isbn_message", false, false)' value="<%= isbn %>"> 
                                            <% } %>
                                        <%
                                           } else if (source.equals("Buch Löschen")) {
                                        %>
                                            ...
                                            <% if (!input5.equalsIgnoreCase("")) { %>
                                                <!-- isbn input field : up to 13 characters can be entered -->
                                                <input type="text" class="form-control form-control-sm" disabled maxlength="13" name="isbn" id="isbn" value="<%= input5 %>"> 
                                            <!-- otherwise read the record from the DB and show it -->
                                            <% } else { %>
                                                <input type="text" class="form-control form-control-sm" disabled maxlength="13" name="isbn" id="isbn" value="<%= isbn %>"> 
                                            <% } %>
                                        <% 
                                           } 
                                        %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        %>
                                            ...
                                            <% if (!input6.equalsIgnoreCase("")) {
                                                ...
                                                input6 = input6.replace('!','.');
                                            %>
                                                <input type="text" class="form-control form-control-sm" name="price" id="price" maxlength="8" onchange="setCookie()" onfocusout='isPrice("upd_del_book", "price", "is_price", "price_message")' value="<%= input6 %>"> 
                                            <!-- otherwise read the record from the DB and show it -->
                                            <% } else {
                                                // in the database the format of the price is 999.99 instead of 999,99
                                                // price = price.replace('.',',');
                                            %>
                                                <input type="text" class="form-control form-control-sm" name="price" id="price" maxlength="8" onchange="setCookie()" onfocusout='isPrice("upd_del_book", "price", "is_price", "price_message")' value="<%= price %>"> 
                                            <% } %>
                                        <%
                                           } else if (source.equals("Buch Löschen")) {
                                        %>
                                            ...
                                            <% if (!input6.equalsIgnoreCase("")) { 
                                                ...
                                                input6 = input6.replace('!','.');
                                            %>
                                                <input type="text" class="form-control form-control-sm" disabled name="price" id="price" maxlength="7" value="<%= input6 %>"> 
                                            <!-- otherwise read the record from the DB and show it -->
                                            <% } else { 
                                                // in the database the format of the price is 999.99 instead of 999,99
                                                // price = price.replace('.',',');
                                            %>
                                                <input type="text" class="form-control form-control-sm" disabled name="price" id="price" maxlength="7" value="<%= price %>"> 
                                            <% } %>
                                        <% 
                                           } 
                                        %>
