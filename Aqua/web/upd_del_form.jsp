                                    ...
                                    <div class="form-group">
                                        ...
                                        %>
                                            ...
                                            <% if (!input6.equalsIgnoreCase("")) { 
                                                input6 = input6.replace('!',','); // in the cookie the , became ! - now I am changing it back
                                            %>
                                                <input type="text" class="form-control form-control-sm" disabled name="price" id="price" maxlength="8" value="<%= input6 %>"> 
                                            <!-- otherwise read the record from the DB and show it -->
                                            <% } else { %>
                                                <input type="text" class="form-control form-control-sm" disabled name="price" id="price" maxlength="8" value="<%= price %>"> 
                                            <% } %>
                                        <% 
                                           } 
                                        %>
