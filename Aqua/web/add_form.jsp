                            ...
                            <div class="col">
                                ...
                                <form id="add_book" name="add_book" action="AddServlet" method="post" onsubmit="return checkForm();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="price" id="price" maxlength="8" onchange="setCookie()" onfocusout='isPrice("add_book", "price", "is_price", "price_message")' value="<%= input3 %>"> 
