...
public class AddServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String sTitle = "Nova knjiga"; // used for passing the title to the error_succ.jsp
        ...
        if ((sMessage.equals("ERR_ADD")) || (sMessage.equals("ERR_ADD_EXISTS"))) {
            ...
            sTitle = "Nova knjiga"; // used for passing the title to the JSP
        }
        
        hSession.setAttribute("source_name", "Nova knjiga"); // on which page I am now
