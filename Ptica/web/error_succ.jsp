    ...
    <head>
        ...
        <%
            ...
            if (sSource.equalsIgnoreCase("Nova knjiga")) {
                out.print("<title>Nova knjiga</title>"); 
                ...
                out.print("<title>Pretraga knjiga</title>"); 
            } else if (sSource.equalsIgnoreCase("Ažuriraj knjigu")) {
                out.print("<title>Ažuriraj knjigu</title>"); 
                    ...
                    <div class="container">
                        <div class="row"> <!-- adding a new row to the Bootstrap grid -->
                            <div class="col">
                                ...
                                <%
                                    } else if (sSource.equalsIgnoreCase("Izbriši knjigu")) { 
                                %>
