    ...
    <body class="greybckgr"> <!-- greybckgr - class which defines grey background (templatecss.css) -->
        <div class="container">
            ...
            <%
                ...
                attr_found = PticaMetodi.sessVarExists(hSession1, "is_error"); // sessVarExists: returns whether the session var. is_error exists in the session
                                ...
                                %>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="AddSessVar" onclick="cookieFillIn('index.jsp')">Najnovija izdanja</a> <!-- Najnovija izdanja link on the submenu -->
