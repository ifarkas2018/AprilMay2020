...
<html>
    ...
    <body> 
        <%
            ...
            is_attr_found = PticaMetodi.sessVarExists(hSess, "is_error"); // sessVarExists: returns whether the session var. is_error exists in the session
                ...
                <div class="container"> 
                    <div class="row"> 
                        ...
                        <!-- the Bootstrap column takes 2 columns on the large screen, 2 columns on the medium sized screens,
                             4 columns on the small sized screens, 6 columns on the extra small screens -->
                        <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
                            <h3> O nama </h3> <!-- title of the column -->
